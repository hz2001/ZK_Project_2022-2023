...
# Date: 9/13/2022
import sys
whitelist = ["import numpy", "import socket", "hello world"]
...
'''
alphabet = {'import': [1, 2, None], 'numpy': [2, 1, 'import'], 'socket': [3, 1, 'import'], 'hello': [4, 1, 'import'], 'world': [5, 1], 'else': [0, 0]}       'import': [word id, occurance]

Ex: states: {0:{unaccept,counter,1,4}, 1:{unaccept,counter,1,4,2,3,0}, 2:{accept, counter,0,1,4}, 3:{accept, counter,0,1,4},4:{unaccept,counter,0,1,4,5},5{accept,counter,0,1}}
'''
